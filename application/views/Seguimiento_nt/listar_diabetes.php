...
<div class="col-sm-12 widget-container-col" id="widget-container-col-2">
   ...
   <center>  <h3 class="box-title">  Establecimiento:  <?php echo $establecimiento->Nombre_Establecimiento ?>&nbsp;&nbsp;&nbsp;Fecha actualización: <?php echo $fecha_actualizacion ?></h3> </center>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <th>Dx. Diabetes</th>
                <th>Tratamientos de Diabetes</th>
                <th> Control de Diabetes</th>                                                                      
             ...
             foreach ($result2 as $row) {
                ...
                <tr>
                 ...
                 <?php if ($row->Diabetes_Militus>=2) { ?> 
                                                                  <td style="background-color:#ffbdc1;font-size:14px;">
                                                                        <center> <b><?php echo $row->Diabetes_Militus ?></b>
                                                                             <div class="tool-tip">
                                                                        <i class="tool-tip__icon" >?</i>
                                                                        <p class="tool-tip__info">
                                                                           
                                                                          <span class="info__title">Diagnostico Diabetes Duplicado</span><BR>
                                                                      ...
                                                                      <?php } elseif ($row->Diabetes_Militus==0) { ?>
                  ...
                  <?php if ($row->Diabetes_Tratado>=1) { ?> 
                                                                  <td style="background-color:#48d1cc;font-size:14px;">
                                                                        <center> <b><?php echo $row->Diabetes_Tratado ?></b>
                   ...
                   <?php if ($row->Diabetes_Controlado>=3) { ?> 
                                                                  <td style="background-color:#ffbdc1;font-size:14px;">
                                                                        <center> <b><?php echo $row->Diabetes_Controlado ?></b>
                                                                            
                                                                    </td>

                                                                   
                                                                      <?php } elseif ($row->Diabetes_Controlado==0) { ?>
                                                                      <td style="font-size:11px; ">
                                                                        <center> 
                ...
                <td>
                  <center>
                        <a class='iframe' href="<?php echo base_url()?>Detalle_error/mostrar_seguimiento_diabetes_detalle/<?php echo $row->Codigo_Unico ?>/<?php echo $row->Numero_Documento?>"><i class="fa fa-eye bigger-200"></i></a></center>
                      </td>
