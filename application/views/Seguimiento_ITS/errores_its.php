...
echo form_open_multipart('Seguimiento_ITS/Listar_errores_its',$atributos);
?>
                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                         ...
                         <td class="hidden-480">
                              ...
                              <?php echo $row->ERROR_ITS ?>
                            
                    </td>

                             <td >
                           <a class='iframe' href="<?php echo base_url()?>Detalle_error/mostrar_errores_its_detalle/<?php echo $row->Codigo_Unico ?>/<?php echo $row->Id_Cita?>"><i class="fa fa-eye bigger-200"></i></a>
                             </td>
