...
echo form_open_multipart('TbcMetaxenicas/Tbc_contacto',$atributos);?>
    <div class="col-md-6">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        <thead class="thin-border-bottom">
                            <tr>
                                ...
                                <th>Contacto Censado</th>
                                <th>Contacto Examinado</th>
                            </tr>
                        </thead>
                            <tbody>
                            ...
                            {?> 
                                <tr>
                                    ...
                                    { ?> 
                                        ...
                                        <center> <?php echo $row->CC ?>
                                        <a target=blank href="<?php echo base_url()?>Detalle_error/mostrar_detalle_tbc/2/CC/<?php echo $RENAES?>/<?php echo $row->Nro_Doc?>/<?php echo $row->FichaFam?>">
                                    ...
                                    <?php } else
                                    { ?>
                                        <td><center> <?php echo $row->CC ?></center></td>
                                    <?php } ?>
                                    
                                    <?php if ($row->CE==1) 
                                    { ?> 
                                        <td style="background-color:#8fffc9;">
                                        <center> <?php echo $row->CE ?>
                                        <a target=blank href="<?php echo base_url()?>Detalle_error/mostrar_detalle_tbc/2/CE/<?php echo $RENAES?>/<?php echo $row->Nro_Doc?>/<?php echo $row->FichaFam?>">
                                        <i class="fa fa-check bigger-200"></i></a></center></td>
                                    <?php } elseif ($row->CE>=2) 
                                    { ?>
                                        <td style="background-color:#ff9e81;">
                                    ...
                                    <?php } else
                                    { ?>
                                        <td><center><?php echo $row->CE ?></center></td>
                                    <?php } ?>
                                </tr>
