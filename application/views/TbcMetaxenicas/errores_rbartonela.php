...
echo form_open_multipart('TbcMetaxenicas/Errores_rbartonela',$atributos);
?>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover">
                                                            ...
                                                            foreach ($result1 as $row) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php echo $row->FichaFam?>
                                                                    </td>
                                                                    <td>
                                                                        <?php echo $row->Nro_Doc?>
                                                                    </td>
                                                                    <td>
                                                                        <?php echo $row->Paciente?>
                                                                    </td>
                                                                    <td>
                                                                        <?php echo $row->Profesional?>
                                                                    </td>
                                                                     <td>
                                                                        <?php echo $row->Lote?>
                                                                    </td>
                                                                    <td>
                                                                        <?php echo $row->Cie1?> <?php echo $row->Cie2?> <?php echo $row->Cie3?> <?php echo $row->Cie4?> <?php echo $row->Cie5?> <?php echo $row->Cie6?>
                                                                    </td>
